...
from app.config import get_db_connection  # Import database connection utility
from flask_jwt_extended import jwt_required  # Import JWT handling for authentication
from app.cache.redis_cache import set_cache, get_cache, delete_cache  # Import caching utilities
